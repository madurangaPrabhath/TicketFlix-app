    ...
    <nav className="fixed top-0 left-0 right-0 bg-linear-to-b from-black/40 to-black/20 backdrop-blur-sm z-50">
      <div className="max-w-7xl mx-auto px-6 h-[70px] flex items-center justify-between gap-8">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `text-gray-400 text-base font-medium no-underline px-1 py-2 relative transition-colors duration-300 hover:text-white ${
                  isActive
                    ? 'text-white font-semibold after:content-[""] after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-red-600'
                    : 'after:content-[""] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-red-600 after:transition-all after:duration-300 hover:after:w-full'
                }`
              }
            >
              Home
        ...
        <div className="flex items-center gap-4 shrink-0">
          ...
          {isSearchOpen && (
            <>
              <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-40 animate-fadeIn"></div>

              <form
                ref={searchRef}
                onSubmit={handleSearch}
                className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[90%] max-w-2xl animate-slideDown"
              >
                <div className="relative">
                  ...
                  <input
                    ...
                    autoFocus
                    className="w-full pl-12 pr-12 py-4 bg-neutral-900 border-2 border-red-600/50 focus:border-red-600 text-white text-lg rounded-xl outline-none transition-all duration-300 shadow-2xl shadow-red-600/20"
                  />
                  <button
                    type="button"
                    onClick={() => setIsSearchOpen(false)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-white p-2 rounded-full hover:bg-white/10 transition-all duration-300"
        ...
        <div
          ...
          } w-[280px] h-screen bg-linear-to-b from-neutral-900 to-black shadow-[-5px_0_20px_rgba(0,0,0,0.5)] pt-20 px-6 pb-6 transition-all duration-300 z-1001 overflow-y-auto`}
        >
          <button
