...
export const getShowById = async (req, res) => {
    try {
        ...
        const show = await Show.findById(showId)
            .populate('movieId', 'title poster_path backdrop_path runtime director cast');
...
export const bookSeats = async (req, res) => {
    try {
        ...
        const alreadyBooked = seats.filter(seat => show.seats.booked.includes(seat));
...
export const releaseSeats = async (req, res) => {
    try {
        ...
        show.seats.booked = show.seats.booked.filter(seat => !seats.includes(seat));
...
export const nowPlayingMovies = async (req, res) => {
    try {
        ...
        const movieIds = [...new Set(shows.map(show => show.movieId._id.toString()))];
